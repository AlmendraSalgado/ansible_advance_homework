...
MitziCom has asked to provide a Proof of Concept using Red Hat Ansible Tower, Red Hat Ansible and Red Hat Openstack to determine the feasibility of using Ansible Tower as a CI/CD tool for automating continuous deployment of an internal three-tier application on QA and production environments.
